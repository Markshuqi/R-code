...
setwd("")       #ÉèÖÃ¹¤×÷Ä¿Â¼
rt=read.table(".txt", header=T, sep="\t", check.names=F)     #¶ÁÈ¡ÊäÈëÎÄ¼þ
...
#Öù×´Í¼
pdf(file="GO barplot.pdf", width=8, height=7)
...
#ÆøÅÝÍ¼
pdf(file="GO bubble.pdf", width=8, height=7)
...
ggbarplot(data, x="Description", y="Count", fill = "ONTOLOGY", color = "white",
		  xlab="Term",
          orientation = "horiz",   #Í¼ÐÎºáÏòÏÔÊ¾
          palette = "aaas",    #ÉèÖÃÑÕÉ«·½°¸
          legend = "right",    #Í¼ÀýÎ»ÖÃ
          sort.val = "asc",    #GOÅÅÐò·½Ê½
          sort.by.groups=TRUE)+    #¸ù¾ÝGO·Ö×é½øÐÐÅÅÐò
